...
int main(int argc, const char *argv[])
{
    ...
    int imgEndIndex = 3;   // last file index to load
    int imgStepWidth = 1;
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex+=imgStepWidth)
    {
        ...
        if (dataBuffer.size() > 1) // wait until at least two images have been processed
        {
            ...
            for (auto it1 = (dataBuffer.end() - 1)->bbMatches.begin(); it1 != (dataBuffer.end() - 1)->bbMatches.end(); ++it1)
            {
                ...
                else if( currBB->lidarPoints.size()>0 || prevBB->lidarPoints.size()>0 ){
                  cout<<"**************************************************************************************************************"<<endl;
                  cout<<"Current Lidar Point Size: "<<currBB->lidarPoints.size()<<"Prev Lidar Point Size: "<<prevBB->lidarPoints.size()<<endl;
                }
